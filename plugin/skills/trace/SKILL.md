...
```sh
npx @arielbk/trace@0.13.0 skill work-on-task "X" --description "Rework the checkout into a multi-step wizard"
```
...
```sh
npx @arielbk/trace@0.13.0 skill work-on-task "X" --project /path/to/that/repo
```
