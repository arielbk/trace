...
```sh
npx @arielbk/trace@0.10.1 skill docs-dir
```
...
```sh
npx @arielbk/trace@0.10.1 task add-doc <slug> <path> --description "<one-line description>"
```
...
```sh
npx @arielbk/trace@0.10.1 task update-doc <slug> <path> --description "<one-line description>"
```
