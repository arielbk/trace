...
```sh
node /Users/arielbk/Projects/side/trace-v2/apps/cli/dist/trace.js task add-doc <slug> <path> --description "<one-line description>"
```
...
```sh
node /Users/arielbk/Projects/side/trace-v2/apps/cli/dist/trace.js task update-doc <slug> <path> --description "<one-line description>"
```
