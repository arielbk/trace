...
```sh
npx @arielbk/trace@0.11.0 skill docs-dir
```
...
```sh
npx @arielbk/trace@0.11.0 task add-doc <slug> <path> --description "<one-line description>"
```
...
```sh
npx @arielbk/trace@0.11.0 task update-doc <slug> <path> --description "<one-line description>"
```
