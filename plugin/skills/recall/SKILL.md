...
```sh
npx @arielbk/trace@0.11.0 skill recall-candidates
```
...
```sh
npx @arielbk/trace@0.11.0 skill recall-candidates --project /path/to/that/repo
```
...
```sh
npx @arielbk/trace@0.11.0 skill re-enter "{slug}"
```
