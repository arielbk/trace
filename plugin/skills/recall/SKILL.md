...
```sh
npx @arielbk/trace@0.9.1 skill recall-candidates
```
...
```sh
npx @arielbk/trace@0.9.1 skill recall-candidates --project /path/to/that/repo
```
...
```sh
npx @arielbk/trace@0.9.1 skill re-enter "{slug}"
```
