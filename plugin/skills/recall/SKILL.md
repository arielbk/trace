...
```sh
npx @arielbk/trace@0.1.2 skill recall-candidates
```
...
```sh
npx @arielbk/trace@0.1.2 skill recall-candidates --project /path/to/that/repo
```
...
```sh
npx @arielbk/trace@0.1.2 skill re-enter "{slug}"
```
