/**
 * Shared inline SVG icons used across the task list and task detail pages.
 * Kept in one place so both surfaces stay visually consistent.
 */
...
export function UnarchiveIcon({ size = 15 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TranscriptIcon({ size = 14 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
