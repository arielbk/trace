...
```sh
npx @arielbk/trace@0.10.0 task add-doc <slug> <path> --description "<one-line description>"
```
...
```sh
npx @arielbk/trace@0.10.0 task update-doc <slug> <path> --description "<one-line description>"
```
